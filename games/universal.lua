...
local hash = loadstring(downloadFile('Paragonv4/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('Paragonv4/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('Paragonv4/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('Paragonv4/profiles/whitelist.json') and readfile('Paragonv4/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('Paragonv4/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('Paragonv4/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('Paragonv4/assets/new/radaricon.png'),
